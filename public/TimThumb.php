...
if(! defined('MEMORY_LIMIT') )				define ('MEMORY_LIMIT', '1024M');							// Set PHP memory limit
...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 640485760);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
	...
	public function __construct(){
		...
		if(FILE_CACHE_DIRECTORY){
			...
			if (!touch($this->cacheDirectory . '/index.html')) {
				$this->error("Could not create ".$this->cacheDirectory."/index.html file - to fix this create an empty file named index.html file in the cache directory.");
			}
		} else {
